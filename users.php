                            ...
                            <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                <div class="d-flex flex-row align-items-center">
                                    <span class="status status-<?php if($user['status'] === 'online') {
                                                                ...
                                                                ;?>
                                    mr-3">
                                        <span class="rounded-circle profile-image d-block " style="background-image:url('./img/demo/avatars/<?= (has_image($user['image_name'])) ? $user['image_name'] : 'no_image.png' ;?>'); background-size: cover;"></span>
                                    </span>
